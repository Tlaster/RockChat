...
namespace RockChat.UWP.Controls.MasterDetailsView
{
    /// <summary>
    ...
    public partial class MasterDetailsView : ItemsControl
    {
        ...
        private void OnBackRequested(object sender, BackRequestedEventArgs args)
        {
            if (ViewState == MasterDetailsViewState.Details)
            {
                ...
                else // let the OnFrameNavigating method handle it if
        ...
        private void SetVisualState(bool animate)
        {
            ...
            if (SelectedItem != null)
            { 
                VisualStateManager.GoToState(this, hasSelectionState, animate);
            }
            else if (_detailsPresenter?.Content != null && SelectedItem == null)
            {
                VisualStateManager.GoToState(this, hasSelectionState, animate);
            }
            else
            {
                VisualStateManager.GoToState(this, noSelectionState, animate);
            }
        }
